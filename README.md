...
- If you downloaded the `.exe` file, double-click it to start. Windows may ask for confirmation. Click “Run” or “Yes.”
- If you downloaded the `.zip` file, right-click it and select “Extract All…” Extract the files to a folder you choose. Then open that folder and double-click the main program file (usually `.exe`).
